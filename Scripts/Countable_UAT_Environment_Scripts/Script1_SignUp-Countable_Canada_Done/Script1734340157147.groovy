...
WebUI.setText(findTestObject('Object Repository/OnboardingObjects/Page_UAT (Countable)/First Name'), 'Techincal')

WebUI.setText(findTestObject('Object Repository/OnboardingObjects/Page_UAT (Countable)/Last Name'), 'Feasibility')

WebUI.setText(findTestObject('Object Repository/OnboardingObjects/Page_UAT (Countable)/Firm_Name'), 'Tech grooming professional corporation')
