...
WebUI.setText(findTestObject('Create Engagement_Objects/Set_Budget_Amount_Engagemnt'), '5000')
...
WebUI.setText(findTestObject('Create Engagement_Objects/Set_Engagement_Hourly_Rate'), '50')

WebUI.setText(findTestObject('Create Engagement_Objects/Set_Time_Allocation_Cr_Engagement'), '50')
...
WebUI.setText(findTestObject('Create Engagement_Objects/Set_Budget_Amount_Engagemnt'), '80000')
...
WebUI.setText(findTestObject('Create Engagement_Objects/Set_Engagement_Hourly_Rate'), '2000')

WebUI.setText(findTestObject('Create Engagement_Objects/Set_Time_Allocation_Cr_Engagement'), '100')
