...
WebUI.click(findTestObject('Checklist_Objects/Compilation_Template'))
...
WebUI.mouseOver(findTestObject('Checklist_Objects/Client_Acceptance_Mapped'))

WebUI.click(findTestObject('Checklist_Objects/Cross_Client_Acceptance'))

WebUI.click(findTestObject('Checklist_Objects/Map_Template'))

WebUI.click(findTestObject('Checklist_Objects/Expand_Last_Folder'))

WebUI.click(findTestObject('Checklist_Objects/Client_Acceptance_On_Map_Template_Popup'))

WebUI.delay(2)

WebUI.mouseOver(findTestObject('Checklist_Objects/Independence_Mapped'))

WebUI.click(findTestObject('Checklist_Objects/Cross_Independance'))

WebUI.click(findTestObject('Checklist_Objects/Map_Template'))

WebUI.click(findTestObject('Checklist_Objects/Expand_Last_Folder'))

WebUI.click(findTestObject('Checklist_Objects/Independence_on_Map_Template'))

WebUI.delay(2)

WebUI.mouseOver(findTestObject('Checklist_Objects/Knowledge_Mapped'))

WebUI.click(findTestObject('Checklist_Objects/Cross_Knowledge'))

WebUI.click(findTestObject('Checklist_Objects/Map_Template'))

WebUI.click(findTestObject('Checklist_Objects/Expand_Last_Folder'))

WebUI.click(findTestObject('Checklist_Objects/Knowledge_On_Map_Template'))

WebUI.delay(2)

WebUI.mouseOver(findTestObject('Checklist_Objects/Planning_Mapped'))

WebUI.click(findTestObject('Checklist_Objects/Cross_Planning'))

WebUI.click(findTestObject('Checklist_Objects/Map_Template'))

WebUI.click(findTestObject('Checklist_Objects/Expand_Last_Folder'))

WebUI.click(findTestObject('Checklist_Objects/Planning_On_Map_Template'))
...
WebUI.click(findTestObject('Checklist_Objects/Set_as_default_compilation'))
