...
List<Map> PLANnsideeng = driver.findElements(By.xpath('//div[contains(@class,\'card ng-star-inserted\')]'))
...
List<Map> COMPnsideeng = driver.findElements(By.xpath('//div[contains(@class,\'card ng-star-inserted\')]'))
