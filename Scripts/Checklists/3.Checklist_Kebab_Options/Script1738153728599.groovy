...
WebUI.mouseOver(findTestObject('Checklist_Objects/Client_Acceptance_FirmTemplate'))
...
WebUI.click(findTestObject('Checklist_Objects/Select_Checklist_Folder_Firm_Template'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Checklist_Objects/Rename_Text'), 'Independence renamed')
...
WebUI.click(findTestObject('Checklist_Objects/Select_Checklist_Folder_Firm_Template'))
...
WebUI.scrollToElement(findTestObject('Checklist_Objects/Duplicated_Checklist'), 0)

WebUI.click(findTestObject('Checklist_Objects/Duplicated_Checklist'))
