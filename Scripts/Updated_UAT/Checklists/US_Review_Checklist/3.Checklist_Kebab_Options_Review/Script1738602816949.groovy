...
WebUI.mouseOver(findTestObject('Checklist_Objects/New_Engagement_Acceptance_ChkList'))
...
WebUI.click(findTestObject('Checklist_Objects/Review_Checklists_Folder_Firm'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Checklist_Objects/Rename_Text'), 'Existing renamed')
...
WebUI.setText(findTestObject('Notes_Firm/FolderName'), 'Release Review Move')
...
WebUI.click(findTestObject('Checklist_Objects/Review_Checklists_Folder_Firm'))
...
WebUI.click(findTestObject('Checklist_Objects/Duplicated_Review_Checklist'))
