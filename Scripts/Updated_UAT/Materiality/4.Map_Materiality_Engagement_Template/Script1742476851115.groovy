...
WebUI.setText(findTestObject('Notes_Firm/FolderName'), 'Review Template Materiality')
...
WebUI.mouseOver(findTestObject('Materiality/Materiality'))

WebUI.click(findTestObject('Materiality/Cross_Materiality'))
