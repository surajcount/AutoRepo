...
WebUI.setText(findTestObject('Client_All_RegressionCase/AddNewClient_FirstName'), 'HMTech')
...
WebUI.setText(findTestObject('Client_All_RegressionCase/AddNewClient_Address'), 'Grand Valley State University')

WebUI.setText(findTestObject('Client_All_RegressionCase/AddNewClient_City'), 'Allendale')

WebUI.setText(findTestObject('Client_All_RegressionCase/AddNewClient_Province_State'), 'Michigan')

WebUI.setText(findTestObject('Client_All_RegressionCase/AddNewClient_Country'), 'United States')

WebUI.setText(findTestObject('Client_All_RegressionCase/AddNewClient_PinCode'), '49401')
