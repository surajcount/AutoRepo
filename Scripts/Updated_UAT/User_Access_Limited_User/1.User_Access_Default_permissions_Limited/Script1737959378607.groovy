...
WebUI.setText(findTestObject('AddTeam_AllRegression_Dashboard/First Name_Team'), 'Limited')
...
//General User
List<Map> expectedPermissions = [[('name') : 'Access to dashboard', ('type') : 'checkbox', ('value') : false], [('name') : 'Edit firm information'
    ...
    , [('name') : 'Can delete team members', ('type') : 'checkbox', ('value') : false], [('name') : 'Can add clients', ('type') : 'checkbox'
        , ('value') : false], [('name') : 'Can view clients', ('type') : 'dropdown', ('value') : 'Custom'], [('name') : 'Can edit clients'
        , ('type') : 'dropdown', ('value') : 'None'], [('name') : 'Can delete clients', ('type') : 'checkbox', ('value') : false]
    , [('name') : 'Can create engagements', ('type') : 'checkbox', ('value') : false], [('name') : 'Can view engagements'
        , ('type') : 'dropdown', ('value') : 'None'], [('name') : 'Can edit engagements', ('type') : 'dropdown', ('value') : 'None']
    , [('name') : 'Can delete engagements', ('type') : 'checkbox', ('value') : false], [('name') : 'Can create templates'
        , ('type') : 'checkbox', ('value') : false], [('name') : 'Can view templates', ('type') : 'checkbox', ('value') : false]
    , [('name') : 'Can edit templates', ('type') : 'dropdown', ('value') : 'None'], [('name') : 'Can delete templates', ('type') : 'dropdown'
        , ('value') : 'None']]
...
WebUI.verifyTextPresent('You do not have access to this page', false)
