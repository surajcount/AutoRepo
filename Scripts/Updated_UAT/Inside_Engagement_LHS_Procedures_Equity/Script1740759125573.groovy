...
//Equity
if (WebUI.verifyElementPresent(findTestObject('Procedures_Object/Equity_Sub_Sec'), 0)) {
    WebUI.click(findTestObject('Procedures_Object/Equity_Sub_Sec'))

    if (WebUI.verifyElementPresent(findTestObject('LHS_InsideEngagement/Procedures/Share_Capital'), 0)) {
        WebUI.click(findTestObject('LHS_InsideEngagement/Procedures/Share_Capital'))
    }
    
    if (WebUI.verifyElementPresent(findTestObject('LHS_InsideEngagement/Procedures/Equity_LS'), 0)) {
        WebUI.mouseOver(findTestObject('LHS_InsideEngagement/Procedures/Equity_LS'))

        WebUI.click(findTestObject('LHS_InsideEngagement/Procedures/Equity_LS_Kebab'))
        ...
        WebUI.setText(findTestObject('Procedures_Object/Document_name'), 'Created under Equity using automation')

        WebUI.setText(findTestObject('Procedures_Object/Document_Description'), 'Equity : It makes the code optimized, we can retrieve or sort the data efficiently.')
        ...
        WebUI.uploadFile(findTestObject('Procedures_Object/Upload_Documents'), 'C:\\Users\\Admin\\Desktop\\Upload_Functions_Test\\Ann10402 (3).pdf')

        WebUI.uploadFile(findTestObject('Procedures_Object/Upload_Documents'), 'C:\\Users\\Admin\\Desktop\\Upload_Functions_Test\\Ann10402 (1).doc')

        WebUI.uploadFile(findTestObject('Procedures_Object/Upload_Documents'), 'C:\\Users\\Admin\\Desktop\\Upload_Functions_Test\\Clients_2025-02-25.xlsx')
        ...
        WebUI.setText(findTestObject('Procedures_Object/Issue_Title'), 'Issue created using automation in Equity')

        WebUI.setText(findTestObject('Procedures_Object/Issue_Description'), 'Equity-An object of a dynamically formed class is called an array in Java. Java array.')
