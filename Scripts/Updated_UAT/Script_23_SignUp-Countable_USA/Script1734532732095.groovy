...
'This Script is designed to Sign-up countable platform selecting country as USA'
WebUI.openBrowser('')
...
WebUI.setText(findTestObject('Object Repository/OnboardingObjects/Page_UAT (Countable)/First Name'), 'US Tech')

WebUI.setText(findTestObject('Object Repository/OnboardingObjects/Page_UAT (Countable)/Last Name'), 'Grooming')

WebUI.setText(findTestObject('Object Repository/OnboardingObjects/Page_UAT (Countable)/Firm_Name'), 'Techniical Concept corporation')

WebUI.setText(findTestObject('Object Repository/OnboardingObjects/Page_UAT (Countable)/Firm size (No. of users)'), '20')
