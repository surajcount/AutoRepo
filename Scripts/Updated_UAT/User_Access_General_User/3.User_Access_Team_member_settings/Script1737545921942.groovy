...
import org.openqa.selenium.support.ui.Select as Select // For handling dropdowns
import java.util.List as List // For using List data structure
...
WebUI.setText(findTestObject('AddTeam_AllRegression_Dashboard/Last Name_Team'), 'Limited')
...
String[] expectedValues = ['General', 'Limited']
