...
String SignCheck = '//li/div/div[@class=\'custom-checkbox\']'
...
//    button = driver.findElement(By.xpath('//div/h5[@title=\'Planning\']/following::ul[1]/li[1]/button'))
//
//    if (button.enabled && button.displayed) {
//        WebUI.click(findTestObject('Sign-Offs_FinalReview_Object/Planning_section_signoffs'))
//    } else {
//        System.out.println('This is compilation or tax engagement hence planning section is not available')
//    }
