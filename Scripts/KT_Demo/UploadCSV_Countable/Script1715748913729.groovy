...
WebUI.click(findTestObject('TEstingUpload/span_Import CSV'))

WebUI.delay(2)

WebUI.uploadFile(findTestObject('TEstingUpload/UploadButton1'), 'C:\\Users\\Admin\\Downloads\\Trial Balance Grouping_2021_peform_import.xlsx')
