...
WebUI.click(findTestObject('User_Access/Access_To_Dashboard'))
...
WebUI.verifyTextNotPresent('You do not have access to this page', false)
...
WebUI.setText(findTestObject('User_Access/Firm_Name'), 'Edited by limited user')
