...
//Revenue
if (WebUI.verifyElementPresent(findTestObject('LHS_InsideEngagement/Procedures/Expenses'), 0)) {
    WebUI.click(findTestObject('LHS_InsideEngagement/Procedures/Expenses'))

    WebUI.click(findTestObject('LHS_InsideEngagement/Procedures/Provision_for_Income_Tax'))

    if (WebUI.verifyElementPresent(findTestObject('LHS_InsideEngagement/Procedures/Provision_for_Tax_LS'), 0)) {
        WebUI.mouseOver(findTestObject('LHS_InsideEngagement/Procedures/Provision_for_Tax_LS'))

        WebUI.click(findTestObject('LHS_InsideEngagement/Procedures/Provision_for_Tax_LS'))

        WebUI.delay(2)

        WebUI.click(findTestObject('LHS_InsideEngagement/Procedures/Provision_for_Tax_LS_Kebab'))
        ...
        WebUI.setText(findTestObject('Procedures_Object/Document_name'), 'Created under Expenses using automation')

        WebUI.setText(findTestObject('Procedures_Object/Document_Description'), 'LS-70 : It makes the code optimized, we can retrieve or sort the data efficiently.')
        ...
        WebUI.uploadFile(findTestObject('Procedures_Object/Upload_Documents'), 'C:\\Users\\Admin\\Desktop\\Upload_Functions_Test\\US 20.4 (1).pdf')

        WebUI.uploadFile(findTestObject('Procedures_Object/Upload_Documents'), 'C:\\Users\\Admin\\Desktop\\Upload_Functions_Test\\client email (2).doc')

        WebUI.uploadFile(findTestObject('Procedures_Object/Upload_Documents'), 'C:\\Users\\Admin\\Desktop\\Upload_Functions_Test\\Trial Balance Grouping (16).xlsx')
        ...
        WebUI.setText(findTestObject('Procedures_Object/Issue_Title'), 'Issue created using automation in Expenses')

        WebUI.setText(findTestObject('Procedures_Object/Issue_Description'), 'Expenses-An object of a dynamically formed class is called an array in Java. Java array.')
        ...
        WebUI.comment('Expenses is not available')
    }
}
