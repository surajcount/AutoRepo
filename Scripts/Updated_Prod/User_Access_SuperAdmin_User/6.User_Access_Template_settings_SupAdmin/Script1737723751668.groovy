...
WebUI.verifyElementText(findTestObject('User_Access/Can edit template'), 'All')

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('User_Access/Can delete template'), 'All')
...
WebUI.verifyTextPresent('Templates', false)
