...
List<Map> SuperAdmins = driver.findElements(By.xpath('//td[4]/span[@title=\'Super Admin\']'))

int SuperCount = SuperAdmins.size()

print('Total no ofSuper Admins in the system are :' + SuperCount)
...
WebUI.setText(findTestObject('AddTeam_AllRegression_Dashboard/First Name_Team'), 'SupAdmin')
...
if (SuperCount < 4) {
    ...
    WebUI.scrollToElement(findTestObject('OnboardingObjects/Page_UAT (Countable)/TermsAcceptanceBTN_CLI_Obording'), 60, 
