...
/*
 * WebDriver driver = DriverFactory.getWebDriver() //boolean
 * luca=driver.findElement(By.xpath("//i[@class='fa-regular fa-xmark']")).
 * isDisplayed()
 * if(driver.findElement(By.xpath("//i[@class='fa-regular fa-xmark']")).
 * isDisplayed()) { WebUI.click(findTestObject('User_Access/Luca_AI_Popup'),
 * FailureHandling.CONTINUE_ON_FAILURE) } else { System.out.println('Luca is not
 * activated') }
 */
	
WebUI.delay(2)
//WebElement luca=WebUI.findWebElement(findTestObject('User_Access/Luca_AI_Popup'))


 try {
	  WebUI.click(findTestObject('User_Access/Luca_AI_Popup'),
...
WebUI.verifyElementNotPresent(findTestObject('Stripe/Billing'), 0)

WebUI.verifyTextNotPresent('Billing', false)
...
WebUI.verifyElementNotPresent(findTestObject('User_Access/Firm_Info_Edit_Button'), 0)

/*
 * WebUI.clearText(findTestObject('User_Access/Firm_Name'))
 * 
 * WebUI.setText(findTestObject('User_Access/Firm_Name'), 'Edited by general
 * user')
 * 
