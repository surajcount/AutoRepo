...
WebUI.click(findTestObject('Create Engagement_Objects/1stClient_AllClients'))
...
'Compilation engagement from client Info page'
...
'Review engagement from client info page'
WebUI.verifyTextPresent('Engagement created successfully', false)
...
'Tax engagement from client info page'
WebUI.verifyTextPresent('Engagement created successfully', false)
