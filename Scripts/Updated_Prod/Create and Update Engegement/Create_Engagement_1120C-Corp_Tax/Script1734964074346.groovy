...
WebUI.click(findTestObject('Create Engagement_Objects/Tax_Template_C_Corp'))
...
WebUI.click(findTestObject('Create Engagement_Objects/Tax_Template_C-corp_Master'))
