...
WebUI.verifyElementText(findTestObject('Client_All_RegressionCase/UploadCSV_Client/VerifyTotalCount_AddNewClient'), '2', 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementClickable(findTestObject('Client_All_RegressionCase/AddClient_Button'), 40)
...
WebUI.verifyElementText(findTestObject('Client_All_RegressionCase/UploadCSV_Client/VerifyTC_AddNewCli_Pst_upld'), '4', FailureHandling.CONTINUE_ON_FAILURE)
