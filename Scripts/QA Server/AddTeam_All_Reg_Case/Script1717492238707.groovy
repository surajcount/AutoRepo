...
WebUI.navigateToUrl('https://qa2.adinovis.com/login')
...
WebUI.setText(findTestObject('AddTeam_AllRegression_Dashboard/Additional AddTeamCase/Search Button_Team'), 'Jef')
...
WebUI.verifyElementText(findTestObject('AddTeam_AllRegression_Dashboard/Additional AddTeamCase/VerifyPartnerCount'), '5')

WebUI.verifyElementText(findTestObject('AddTeam_AllRegression_Dashboard/Additional AddTeamCase/VerifyTotalTeamCount'), '7')
