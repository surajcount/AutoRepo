...
WebUI.setText(findTestObject('Object Repository/OnboardingObjects/Page_UAT (Countable)/input_Firm Name_mat-input-4'), 'Suraj ltd')
...
WebUI.click(findTestObject('Object Repository/OnboardingObjects/Page_UAT (Countable)/span_Ignore'), FailureHandling.CONTINUE_ON_FAILURE)
