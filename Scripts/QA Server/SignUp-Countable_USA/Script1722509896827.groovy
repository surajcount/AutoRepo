...
WebUI.navigateToUrl('https://qa1.adinovis.com/login')
...
WebUI.click(findTestObject('OnboardingObjects/Page_UAT (Countable)/span_Dashboard_toster_crossbutton'), FailureHandling.CONTINUE_ON_FAILURE)
