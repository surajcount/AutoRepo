...
WebUI.callTestCase(findTestCase('Notes to FS/Add_Single_To_Queue_Firm'), [:], FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyTextPresent('Remove Notes from Queue', false)
