...
WebUI.setText(findTestObject('Object Repository/OnboardingObjects/Page_UAT (Countable)/First Name'), 'Suraj')

WebUI.setText(findTestObject('Object Repository/OnboardingObjects/Page_UAT (Countable)/Last Name'), 'Agnihotry')

WebUI.setText(findTestObject('Object Repository/OnboardingObjects/Page_UAT (Countable)/Firm_Name'), 'Quntum Soft')
