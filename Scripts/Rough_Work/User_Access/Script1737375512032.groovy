...
List<Map<String, Object>> expectedPermissions = [
	...
	[name: 'Edit firm information', type: 'checkbox', value: false],
	[name: 'Access to Billing', type: 'checkbox', value: false],
	[name: 'Ability to export platform data', type: 'checkbox', value: false],
	...
	[name: 'Can delete engagements', type: 'checkbox', value: false],
	[name: 'Can create templates', type: 'checkbox', value: true],
	[name: 'Can view templates', type: 'checkbox', value: true], // Dropdown example
	[name: 'Can edit templates', type: 'dropdown', value: 'Own only'],
	[name: 'Can delete templates', type: 'dropdown', value: 'Own only'] // Dropdown example
]
