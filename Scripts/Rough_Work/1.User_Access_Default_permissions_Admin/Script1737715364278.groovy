...
int SupAdm = WebUI.getNumberOfTotalOption(findTestObject('User_Access/No. of Super_Admins'))

print('Total no ofSuper Admins in the system are :' + SupAdm)

if (SupAdm < 4) {
    WebUI.comment('There are fewer than 4 super admins. Adding super admins to reach 4.')

    for (int i = SupAdm + 1; i <= 4; i++) {
        WebUI.click(findTestObject('User_Access/Add_User'))

        WebUI.click(findTestObject('User_Access/Add_Team_member'))
        ...
        WebUI.setText(findTestObject('AddTeam_AllRegression_Dashboard/First Name_Team'), 'Admin')
        ...
        WebUI.click(findTestObject('User_Access/Super_Admin_Access_Type'))

        WebUI.delay(3)

        //General User
        List<Map> expectedPermissions = [[('name') : 'Access to dashboard', ('type') : 'checkbox', ('value') : true], [('name') : 'Edit firm information'
                , ('type') : 'checkbox', ('value') : true], [('name') : 'Access to Billing', ('type') : 'checkbox', ('value') : true]
            , [('name') : 'Ability to export platform data', ('type') : 'checkbox', ('value') : true], [('name') : 'Can add team members'
                , ('type') : 'checkbox', ('value') : true], [('name') : 'Can edit team members', ('type') : 'checkbox', ('value') : true]
            , [('name') : 'Can delete team members', ('type') : 'checkbox', ('value') : true], [('name') : 'Can add clients'
                , ('type') : 'checkbox', ('value') : true], [('name') : 'Can view clients', ('type') : 'dropdown', ('value') : 'All']
            , [('name') : 'Can edit clients', ('type') : 'dropdown', ('value') : 'All'], [('name') : 'Can delete clients'
                , ('type') : 'checkbox', ('value') : true], [('name') : 'Can create engagements', ('type') : 'checkbox', ('value') : true]
            , [('name') : 'Can view engagements', ('type') : 'dropdown', ('value') : 'All'], [('name') : 'Can edit engagements'
                , ('type') : 'dropdown', ('value') : 'All'], [('name') : 'Can delete engagements', ('type') : 'checkbox'
                , ('value') : true], [('name') : 'Can create templates', ('type') : 'checkbox', ('value') : true], [('name') : 'Can view templates'
                , ('type') : 'checkbox', ('value') : true], [('name') : 'Can edit templates', ('type') : 'dropdown', ('value') : 'All']
            , [('name') : 'Can delete templates', ('type') : 'dropdown', ('value') : 'All']]
...
List<Map> expectedPermissions = [[('name') : 'Access to dashboard', ('type') : 'checkbox', ('value') : true], [('name') : 'Edit firm information'
    ...
    , [('name') : 'Ability to export platform data', ('type') : 'checkbox', ('value') : true], [('name') : 'Can add team members'
        , ('type') : 'checkbox', ('value') : true], [('name') : 'Can edit team members', ('type') : 'checkbox', ('value') : true]
    , [('name') : 'Can delete team members', ('type') : 'checkbox', ('value') : true], [('name') : 'Can add clients', ('type') : 'checkbox'
        , ('value') : true], [('name') : 'Can view clients', ('type') : 'dropdown', ('value') : 'All'], [('name') : 'Can edit clients'
        , ('type') : 'dropdown', ('value') : 'All'], [('name') : 'Can delete clients', ('type') : 'checkbox', ('value') : true]
    ...
    , [('name') : 'Can delete engagements', ('type') : 'checkbox', ('value') : true], [('name') : 'Can create templates'
        , ('type') : 'checkbox', ('value') : true], [('name') : 'Can view templates', ('type') : 'checkbox', ('value') : true]
    , [('name') : 'Can edit templates', ('type') : 'dropdown', ('value') : 'All'], [('name') : 'Can delete templates', ('type') : 'dropdown'
        , ('value') : 'All']]
...
WebUI.verifyTextPresent('Exceeded the limit, 4 Super Admins in a firm', false)
