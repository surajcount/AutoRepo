...
WebUI.setText(findTestObject('Create Engagement_Objects/SearchBox_Dashboard'), Seach_Engagement)
...
WebUI.uploadFile(findTestObject('Procedures_Object/Upload_Documents'), 'C:\\Users\\Admin\\Desktop\\Upload_Functions_Test\\Afghan-Adjusting Entries.pdf')
